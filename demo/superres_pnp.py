...
r"""
This demo illustrates the solution of an inverse problem
using the Plug and Play algorithm.  The forward
model is a subsampling operation, and the prior agent is one of
several possible denoisers.

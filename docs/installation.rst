...
To install PnP-MACE, run this command in your terminal:

.. code-block:: console

    $ pip install pnp_mace

This is the preferred method to install PnP-MACE, as it will always install the most recent stable release.
